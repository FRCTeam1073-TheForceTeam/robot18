...
//	 	double encoderOffSet,currentLeftSpeed,currentRightSpeed;
...
//	    	currentLeft = RobotMap.leftMotor3E.getSelectedSensorPosition(0);
...
//	    	currentSpeed = (-(4 / Math.pow(dest, 2)) * Math.pow(currentDist, 2) - ((4 / dest) * currentDist));
//	    	
...
//	    	
//	    	//Set the motors
////	    	Robot.drivetrain.difDrive.arcadeDrive(currentSpeed, (encoderDif * encoderOffSet) + (gyroDif * gyroOffSet));
